        ...
        <div className=''>
            <h2 className='neue-bold text-[20px]'>
                <span className='neue-bold text-[40px]'>A </span> mind blowing  session for teenagers and undergraduates coming up on the <br />
                 <span className='mt-2 neue-bold text-[28px] text-red-500'> 17th of August 2024.
            ...
            <p className='neue-bold text-[20px] mt-5   text-red-600'>MY LIFE MY BRAND!</p>
            
            <h2 className='mt-10 text-[20px] neue-bold track'>
            The registration fee is <span className='mt-2 neue-bold text-[28px] text-red-600'> 5,000 Naira Only</span>
            </h2>
